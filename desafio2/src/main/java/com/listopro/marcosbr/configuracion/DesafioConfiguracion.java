package com.listopro.marcosbr.configuracion;
...
@EntityScan(basePackages = { "com.listopro.marcosbr.entidad" })
@EnableAutoConfiguration
public class DesafioConfiguracion {
	...
	public LocalSessionFactoryBean sessionFactory() throws Exception {
		...
		bean.setPackagesToScan("com.marcosbr.transportes.entidad");
	...
	Properties getHibernateProperties() {
		...
		props.setProperty("hibernate.id.new_generator_mappings",
				environment.getProperty("spring.jpa.properties.hibernate.id.new_generator_mappings"));
		return props;
	}
