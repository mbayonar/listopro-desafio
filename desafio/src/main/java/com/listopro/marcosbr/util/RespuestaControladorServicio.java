package com.listopro.marcosbr.util;
...
public class RespuestaControladorServicio {
	...
	public RespuestaControlador obtenerRespuestaDeExitoCrear(String nombreEntidad) {
		return RespuestaControlador.obtenerRespuestaDeExito(
				MessageFormat.format(Constantes.RESPUESTA_CONTROLADOR.MENSAJE_CREAR_EXITO, nombreEntidad));
	}

	public RespuestaControlador obtenerRespuestaDeExitoCrearConData(String nombreEntidad, Object data) {
		RespuestaControlador respuestaControlador = RespuestaControlador.obtenerRespuestaDeExito(
				MessageFormat.format(Constantes.RESPUESTA_CONTROLADOR.MENSAJE_CREAR_EXITO, nombreEntidad));
	...
	public RespuestaControlador obtenerRespuestaDeExitoActualizar(String nombreEntidad) {
		return RespuestaControlador.obtenerRespuestaDeExito(
				MessageFormat.format(Constantes.RESPUESTA_CONTROLADOR.MENSAJE_ACTUALIZAR_EXITO, nombreEntidad));
	}
	...
	public RespuestaControlador obtenerRespuestaDeErrorActualizar(String nombreEntidad) {
		return RespuestaControlador
				.obtenerRespuestaDeError(MessageFormat.format(mensajeActualizarError, nombreEntidad));
	}

	public RespuestaControlador obtenerRespuestaDeExitoEliminar(String nombreEntidad) {
		return RespuestaControlador.obtenerRespuestaDeExito(
				MessageFormat.format(Constantes.RESPUESTA_CONTROLADOR.MENSAJE_ELIMINAR_EXITO, nombreEntidad));
	}
	...
	public RespuestaControlador obtenerRespuestaDeErrorDuplicado(String nombreEntidad, String propiedadDuplicada) {
		return RespuestaControlador.obtenerRespuestaDeError(MessageFormat
				.format(Constantes.RESPUESTA_CONTROLADOR.MENSAJE_DUPLICADO, nombreEntidad, propiedadDuplicada));
	}
	...
	public RespuestaControlador obtenerRespuestaDeErrorObtener(String nombreEntidad) {
		return RespuestaControlador.obtenerRespuestaDeError(
				MessageFormat.format(Constantes.RESPUESTA_CONTROLADOR.MENSAJE_OBTENER_ERROR, nombreEntidad));
	}

	public RespuestaControlador obtenerRespuestaDeErrorListar(String nombreEntidad) {
		return RespuestaControlador.obtenerRespuestaDeError(
				MessageFormat.format(Constantes.RESPUESTA_CONTROLADOR.MENSAJE_LISTAR_ERROR, nombreEntidad));
	}
